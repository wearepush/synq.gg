...
const data = {
  intheknow: {
    ...
    bodyDescription: <>Don’t get left behind. Stay up to date with the latest sportsbettingodds, picks, and takes from punters like you. <span>You in?</span></>,
  },
  strongertogether: {
    headerTitle: <>Live sportsbetting takes</>,
  ...
  bettogether: {
    ...
    bodyDescription: <>We’re better together. Share your ideas and learn from others likeyou. Join our sportsbetting community for the latest sportsbetting odds, picks, and takes. <span>You in?</span></>,
  },
  edge: {
    headerTitle: <>Live sportsbetting takes</>,
